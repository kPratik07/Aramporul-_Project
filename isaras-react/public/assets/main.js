...
class NavigationMenu {
  ...
  bindEvents() {
    ...
    document.addEventListener("click", (e) => {
      if (!safeClosest(e.target, ".nav-item") && !safeClosest(e.target, ".mega-menu, .dropdown-menu")) {
        this.hideAllMenus();
      }
    });
    ...
    document.addEventListener(
      "mouseenter",
      (e) => {
        if (safeClosest(e.target, ".mega-menu, .dropdown-menu, .mega-menu-bridge, .dropdown-menu-bridge")) {
